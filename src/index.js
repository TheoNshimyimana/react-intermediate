  ...
  return (
    <main className="menu">
      ...
      {numPizza > 0 ? (
        ...
        <p>Sorry, we're still working on menu. Please come back later</p>
      )}
  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>
          We're currently closed. We open at {openHour}:00. Please come back
          later!
        </p>
      )}
    </footer>
...
function Order({ closeHour, OpenHour }) {
  return (
    <div className="order">
      <p>
        We're open from {OpenHour}:00 until {closeHour}:00. Come and visit us or
        order online!
      </p>
